...
export function MessageInput({
  ...
  return (
    <form
      ...
      className="flex items-end gap-2 border-t border-white/10 bg-app-card p-3"
    >
      <button
        type="button"
      ...
      <div className="flex-1">
        ...
        <input
          ...
          className="w-full rounded-lg border border-white/10 bg-app-bg px-3 py-2 text-sm text-app-text-primary outline-none focus:border-app-accent"
        />
      </div>
