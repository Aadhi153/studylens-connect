...
export function Hero() {
  return (
    <section className="hero-band w-full">
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center gap-12 px-6 pb-24 pt-12 md:flex-row md:pt-20">
        <div className="flex flex-1 flex-col items-start gap-6">
          <span className="rounded-full border border-app-border px-3 py-1 text-xs font-medium uppercase tracking-wide text-landing-on-gradient-secondary">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link
              href="/signup"
              className="btn-secondary rounded-lg border border-app-border px-5 py-3 text-sm font-medium text-landing-on-gradient"
            >
              Sign Up Free
            </Link>
          </div>
